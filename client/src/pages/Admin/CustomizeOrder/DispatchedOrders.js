...
import { makeStyles, Paper, TableBody, TableRow, TableCell, Toolbar, Box, InputAdornment, Typography, Table, TableContainer, TableHead, Button, Link } from "@material-ui/core";
    ...
    return (
        ...
        <div style={{ display: "flex" }}>
            ...
            <main className={classes.content}>
                    ...
                    <container>
                        <center>
                        <Typography variant="h5" style={{ textAlign: 'center', backgroundColor: '#C6C6C6', padding: '20px', fontWeight: '600', letterSpacing: '5px' }}>DISPATCHED ORDERS </Typography>
