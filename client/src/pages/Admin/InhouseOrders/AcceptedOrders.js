            ...
            <center>
                <div className={classes.info}>
                    <div className={classes.pageLinks}>
                        ...
                        <Button style={{ borderRadius: '50px', borderWidth: '2px', borderColor: 'black', marginRight: '40px', fontWeight: 'bold', backgroundColor: '#bbd8ff' }} variant="outlined" color="primary" href="http://localhost:3000/AdminOrders/2">
                            Accepted orders
                        </Button>
                ...
                <div className={classes.info}>
                    ...
                    <Paper elevation={2} className={classes.orderDetails}>
                        <Typography variant="h5" style={{ textAlign: 'center', backgroundColor: '#C6C6C6', padding: '30px', fontWeight: '600', letterSpacing: '5px' }}>ACCEPTED ORDERS </Typography>
