...
import { blue, brown, cyan, deepOrange, green, grey, indigo, lightBlue, lightGreen, lime, pink, red, teal, yellow } from "@material-ui/core/colors";
            ...
            <div>
                <Line
                       data={{
                           ...
                           datasets: [
                            {
                              label: 'Customize Sales Amount (Rs)',
                              data:amount,
...
export default LineChartCustomize;